...
#import "FengYunDiYin_Student-Prefix.pch"
...
//    }
    ...
    if (![curUrlStr hasPrefix:@"/"] || [curUrlStr rangeOfString:proName].location != NSNotFound) {
        ...
        curUrl = [NSURL URLWithString:curUrlStr relativeToURL:[NSURL URLWithString:@"*****"]];
    }
...
- (void)shareItemClicked{
    ...
    if (url.absoluteString && ![url.absoluteString isEqualToString:@""]) {

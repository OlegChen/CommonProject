...
- (UIView *)customFooterView{
    ...
    _footerBtn.frame = CGRectMake(20, 20, SCREEN_WIDTH - 20*2, 45);
    
    
    
//    [UIButton buttonWithStyle:StrapSuccessStyle andTitle:@"注册" andFrame:CGRectMake(kLoginPaddingLeftWidth, 20, SCREEN_WIDTH - 20*2, 45) target:self action:@selector(sendRegister)];
...
//        label.activeLinkAttributes = kLinkAttributesActive;
    ...
    NSString *tipStr = @"注册 风云笛 账号表示您已同意《风云笛 服务条款》";
    lineLabel.text = tipStr;
    [lineLabel addLinkToTransitInformation:@{@"actionStr" : @"gotoServiceTermsVC"} withRange:[tipStr rangeOfString:@"《风云笛 服务条款》"]];
...
//    if (_medthodType == RegisterMethodEamil) {
//        if (indexPath.row == 0) {
//            [cell setPlaceholder:@" 用户名（个性后缀）" value:nil];
//            cell.textValueChangedBlock = ^(NSString *valueStr){
////                weakSelf.myRegister.global_key = valueStr;
//            };
//        }else if (indexPath.row == 1){
//            cell.textField.keyboardType = UIKeyboardTypeEmailAddress;
//            [cell setPlaceholder:@" 邮箱" value:nil];
//            cell.textValueChangedBlock = ^(NSString *valueStr){
...
//            [cell setPlaceholder:@" 设置密码" value:nil];
//            cell.textValueChangedBlock = ^(NSString *valueStr){
...
//                weakSelf.myRegister.global_key = valueStr;
            ...
            [cell setPlaceholder:@" 手机号" value:nil];
...
//                weakSelf.myRegister.password = valueStr;
            ...
            cell.textField.keyboardType = UIKeyboardTypeNumberPad;
            [cell setPlaceholder:@" 手机验证码" value:nil];
            cell.textValueChangedBlock = ^(NSString *valueStr){

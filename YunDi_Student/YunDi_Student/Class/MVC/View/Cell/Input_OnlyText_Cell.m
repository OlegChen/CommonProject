...
#define kLoginPaddingLeftWidth  20
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        if ([reuseIdentifier isEqualToString:kCellIdentifier_Input_OnlyText_Cell_Text]) {
            ...
            if (!_captchaView) {
                _captchaView = [[UITapImageView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - 60 - kLoginPaddingLeftWidth, (44-25)/2, 60, 25)];
            ...
            if (!_passwordBtn) {
                ...
                _passwordBtn = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - 44- kLoginPaddingLeftWidth, 0, 44, 44)];
            ...
            if (!_verify_codeBtn) {
                _verify_codeBtn = [[PhoneCodeButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - 80 - kLoginPaddingLeftWidth, (44-25)/2, 80, 25)];
